...
class ConcreteStateSilent : public State {
    public:
        void playRingTone() {
            cout << "Mobile is in a Silent State. So, it can't play a ring tone\n";
        }
...
class ConcreteStateSwitchedOn : public State {
    public:
        void playRingTone() {
            cout << "Mobile is in a SwitchedOn state and is playing a ring tone\n";
        }
...
int main() {
    ...
    contextSwitchOn->reqTooggleSilentMode();
    contextSwitchOn->reqPlayRingTone();
    contextSwitchOn->reqTooggleSilentMode();
