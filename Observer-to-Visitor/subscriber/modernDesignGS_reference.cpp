...
class Subject {
    public:
        virtual ~Subject() {};
        virtual void subscribe(Observer const& observer) = 0;
        virtual void unsubscribe(Observer const& observer) = 0;
...
class GroceryStore : public Subject {
    public: 
        ...
        // trigger the update message on Observer side
    ...
    private:
        list<Observer const&> list_observer;
};
...
class Customer : public Observer {
    public: 
        ...
        void unsubscribeCustomer() {
            ...
            // is this a good approach? (same unclarity as in constructor)
